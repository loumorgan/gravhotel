...
return [
    ...
    'timestamp' => 1620309986,
    'checksum' => 'ce5048ae6886791ab7c9f904ad1cf827',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/sqlite' => [
                'file' => 'user/plugins/sqlite/blueprints.yaml',
                'modified' => 1608612942
            ]
        ],
        'user/themes' => [
            ...
            'themes/x-corporation' => [
                'file' => 'user/themes/x-corporation/blueprints.yaml',
                'modified' => 1620309984
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'plugins.database.text_var' => [
                'type' => 'text',
                'label' => 'PLUGIN_DATABASE.TEXT_VARIABLE',
                'name' => 'plugins.database.text_var',
                'validation' => 'strict'
            ],
            'plugins.email' => [
                'type' => '_root',
            ...
            'plugins.sqlite.database_name' => [
                'type' => 'text',
                'default' => 'db.sqlite3',
                'label' => 'PLUGIN_SQLITE.DATABASE_NAME',
                'name' => 'plugins.sqlite.database_name'
            ],
            'plugins.sqlite.database_route' => [
                'type' => 'text',
                'default' => 'data',
                'label' => 'PLUGIN_SQLITE.DATABASE_ROUTE',
                'name' => 'plugins.sqlite.database_route'
            ],
            'plugins.sqlite.extra_security' => [
                'type' => 'toggle',
                'default' => 0,
                'highlight' => 0,
                'options' => [
                ...
                'name' => 'plugins.sqlite.extra_security'
            ],
            'plugins.sqlite.logging' => [
                'type' => 'toggle',
                'highlight' => 0,
                'default' => 0,
                'options' => [
                ...
                'name' => 'plugins.sqlite.logging'
            ],
            'plugins.sqlite.all_logging' => [
                'type' => 'toggle',
                'highlight' => 0,
                'default' => 0,
                'options' => [
                ...
                'name' => 'plugins.sqlite.all_logging'
            ],
            'plugins.sqlite.error_logging' => [
                'type' => 'toggle',
                'highlight' => 0,
                'default' => 0,
                'options' => [
                ...
                'name' => 'plugins.sqlite.error_logging'
            ],
            'plugins.sqlite.select_logging' => [
                'type' => 'toggle',
                'highlight' => 0,
                'default' => 0,
                'options' => [
                ...
                'name' => 'plugins.sqlite.select_logging'
            ],
            'plugins.sqlite.insert_logging' => [
                'type' => 'toggle',
                'highlight' => 0,
                'default' => 0,
                'options' => [
                ...
                'name' => 'plugins.sqlite.insert_logging'
            ],
            'plugins.sqlite.update_logging' => [
                'type' => 'toggle',
                'highlight' => 0,
                'default' => 0,
                'options' => [
                ...
                'name' => 'plugins.sqlite.update_logging'
            ],
            'themes.deliver' => [
                'type' => '_root',
                'form_field' => false,
            ...
            'themes.x-corporation.favicon' => [
                ...
                'name' => 'themes.x-corporation.favicon',
                'validation' => 'loose'
            ],
            'themes.x-corporation.copyright' => [
                'type' => 'textarea',
                'label' => 'THEME_X_CORPORATION.ADMIN.COPYRIGHT_TEXT.LABEL',
                'name' => 'themes.x-corporation.copyright',
                'validation' => 'loose'
            ],
            'themes.x-corporation.logo' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.x-corporation.logo',
                'validation' => 'loose'
            ],
            'themes.x-corporation.google_maps_api_key' => [
                'type' => 'text',
                'label' => 'THEME_X_CORPORATION.ADMIN.GOOGLE_MAPS_API_KEY.LABEL',
                'name' => 'themes.x-corporation.google_maps_api_key',
                'validation' => 'loose'
            ],
            'themes.x-corporation.footer_icons' => [
                'array' => true,
                'type' => 'list',
                'label' => 'THEME_X_CORPORATION.ADMIN.FOOTER_ICONS.LABEL',
                'style' => 'vertical',
                'name' => 'themes.x-corporation.footer_icons',
                'validation' => 'loose'
            ],
            'themes.x-corporation.footer_icons.*' => [
                'type' => '_parent',
            ...
            'themes.x-corporation.footer_icons.*.icon' => [
                'type' => 'text',
                'label' => 'THEME_X_CORPORATION.ADMIN.FOOTER_ICONS.ICON.LABEL',
                'name' => 'themes.x-corporation.footer_icons.*.icon',
                'validation' => 'loose'
            ],
            'themes.x-corporation.footer_icons.*.url' => [
                'type' => 'text',
                'label' => 'THEME_X_CORPORATION.ADMIN.FOOTER_ICONS.URL.LABEL',
                'name' => 'themes.x-corporation.footer_icons.*.url',
                'validation' => 'loose'
            ],
            'themes.x-corporation.footer_blocks' => [
                'array' => true,
                'type' => 'list',
                'label' => 'THEME_X_CORPORATION.ADMIN.FOOTER_BLOCKS.LABEL',
                'style' => 'vertical',
                'name' => 'themes.x-corporation.footer_blocks',
                'validation' => 'loose'
            ],
            'themes.x-corporation.footer_blocks.*' => [
                'type' => '_parent',
            ...
            'themes.x-corporation.footer_blocks.*.title' => [
                'type' => 'text',
                'label' => 'THEME_X_CORPORATION.ADMIN.FOOTER_BLOCKS.TITLE.LABEL',
                'name' => 'themes.x-corporation.footer_blocks.*.title',
                'validation' => 'loose'
            ],
            'themes.x-corporation.footer_blocks.*.content' => [
                'type' => 'textarea',
                'rows' => 5,
                'label' => 'THEME_X_CORPORATION.ADMIN.CONTENT.LABEL',
                'name' => 'themes.x-corporation.footer_blocks.*.content',
                'validation' => 'loose'
            ],
            'themes.x-corporation.footer_blocks.*.logo' => [
                'type' => 'toggle',
                'toggleable' => false,
                ...
                'name' => 'themes.x-corporation.footer_blocks.*.logo',
                'validation' => 'loose'
            ],
            'themes.x-corporation.footer_blocks.*.icons' => [
                'type' => 'toggle',
                'toggleable' => false,
                ...
                'name' => 'themes.x-corporation.footer_blocks.*.icons',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'database' => [
                    ...
                    'text_var' => 'plugins.database.text_var'
                ],
                'email' => [
                ...
                'sqlite' => [
                    'database_name' => 'plugins.sqlite.database_name',
                    'database_route' => 'plugins.sqlite.database_route',
                    'extra_security' => 'plugins.sqlite.extra_security',
                    'logging' => 'plugins.sqlite.logging',
                    'all_logging' => 'plugins.sqlite.all_logging',
                    'error_logging' => 'plugins.sqlite.error_logging',
                    'select_logging' => 'plugins.sqlite.select_logging',
                    'insert_logging' => 'plugins.sqlite.insert_logging',
                    'update_logging' => 'plugins.sqlite.update_logging'
                ]
            ],
            'themes' => [
                'deliver' => [
                ...
                'x-corporation' => [
                    'favicon' => 'themes.x-corporation.favicon',
                    'copyright' => 'themes.x-corporation.copyright',
                    'logo' => 'themes.x-corporation.logo',
                    'google_maps_api_key' => 'themes.x-corporation.google_maps_api_key',
                    'footer_icons' => [
                        '*' => [
                            'icon' => 'themes.x-corporation.footer_icons.*.icon',
                            'url' => 'themes.x-corporation.footer_icons.*.url'
                        ]
                    ],
                    'footer_blocks' => [
                        '*' => [
                            'title' => 'themes.x-corporation.footer_blocks.*.title',
                            'content' => 'themes.x-corporation.footer_blocks.*.content',
                            'logo' => 'themes.x-corporation.footer_blocks.*.logo',
                            'icons' => 'themes.x-corporation.footer_blocks.*.icons'
                        ]
                    ]
                ]
            ]
