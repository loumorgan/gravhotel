...
return [
    ...
    'timestamp' => 1620309985,
    'checksum' => '3410cff50033ccb2b80cd5889adda56d',
    'files' => [
        'user/config' => [
            'media' => [
            ...
            'plugins/database' => [
                'file' => 'user/config/plugins/database.yaml',
                'modified' => 1620277299
            ],
            'plugins/email' => [
            ...
            'plugins/sqlite' => [
                'file' => 'user/config/plugins/sqlite.yaml',
                'modified' => 1620277308
            ],
            'security' => [
        ...
        'user/plugins' => [
            ...
            'plugins/sqlite' => [
                'file' => 'user/plugins/sqlite/sqlite.yaml',
                'modified' => 1608612942
            ]
        ],
        'user/themes' => [
            ...
            'themes/x-corporation' => [
                'file' => 'user/themes/x-corporation/x-corporation.yaml',
                'modified' => 1620309984
            ]
        ]
    ],
...
node_modules'
        ...
        'site' => [
            ...
            'author' => [
                'name' => 'Lou Morgan',
                'email' => 'loumorgan.preformation@gmail.com'
            ],
            'taxonomies' => [
                0 => 'category',
                1 => 'tag'
